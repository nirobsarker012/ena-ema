  ...
  return (
    <main className="container px-4 md:px-6 lg:px-12">
      ...
      <div className="flex flex-col items-center justify-center text-center">
        <span className="inline-flex items-center text-text-secondary-light bg-card-bg py-2 px-4 gap-x-2 rounded-full border-t border-primary text-sm md:text-base">
