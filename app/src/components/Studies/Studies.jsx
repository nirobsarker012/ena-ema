  ...
  return (
    <section>
      ...
      <div className=" contaier max-w-[244px] mx-auto">
        <button className="mt-6 w-full inline-flex justify-center text-[12px] px-1.5 lg:px-0 items-center gap-3 bg-primary py-4 text-primary-dark lg:text-[16px] rounded-lg font-medium hover:rounded-2xl transition-all duration-300 hover:gap-5 cursor-pointer">
